...
<h1>Edit Restaurant</h1>
  <form method="post" action="{{action('RestaurantController@update',$id)}}" enctype="multipart/form-data">
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        ...
        id="lgFormGroupInput" placeholder="name" name="name" value="{{$restaurant['name']}}">
      </div>
    </div>
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        <input type="text" class="form-control form-control-lg" id="lgFormGroupInput"
         placeholder="hotline" name="hotline" value="{{$restaurant['hotline']}}">
      </div>
    </div>
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        <input type="text" class="form-control form-control-lg" 
        id="lgFormGroupInput" placeholder="Cuisine" name="cuisine" value="{{$restaurant['cuisine']}}">
      </div>
    </div>
    <div class="form-group row">
      ...
      <div class="col-sm-10">
      <input type="text" class="form-control form-control-lg" 
        id="lgFormGroupInput" placeholder="Address" name="address" value="{{$restaurant['address']}}">
      </div>
    </div>
